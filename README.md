The purpose of this is to enable Arch users to build the most recently commited code to the TrenchBroom GitHub main branch that will eventually roll into TrenchBroom 2024+.
